...
- [ ] Paste `STORE_LISTING.md` into the listing.
- [ ] Replace and publicly host `PRIVACY_POLICY_TEMPLATE.md`.
- [ ] Complete Data safety using `DATA_SAFETY.md`.
- [ ] Declare: no ads; no account; Health & Fitness category; general-wellness use only.
